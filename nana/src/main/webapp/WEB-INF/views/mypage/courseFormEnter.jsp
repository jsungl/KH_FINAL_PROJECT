...
function enrollListCourse(){
	if (confirm("현재 코스를 등록하시겠습니까?") == true){
	    document.form.submit();
	}else{
	    return;
	}
                ...
                <div class="row col-xs-12" style="padding: 0 40px;">
                    ...
                    <div class="col-4" style="margin-top: 20px; margin-bottom: 20px; border: 1px solid black;">
                        ...
                        <form class="course-div"
		                        ...
		                        action="${pageContext.request.contextPath}/mypage/courseListEnroll?${_csrf.parameterName}=${_csrf.token}"
								method="post"
								onsubmit="return enrollListCourse();">
		                    <input type="hidden" name="id" value="${principal.id}">
						...
						<c:forEach items="${courseList}" var="course">
							<form class="course-div"
		                        ...
		                        action="${pageContext.request.contextPath}/mypage/courseDelete?${_csrf.parameterName}=${_csrf.token}"
								method="post"
								data-no="${course.no}"
