...
<script src="//dapi.kakao.com/v2/maps/sdk.js?appkey=${kakaoServiceKey}&libraries=services"></script>
<div class="container mt-5 mb-5">
	<h1 class="text-center">장소 추가 </h1>
	<div id="demo-container"
		...
		<form:form id="adminPlaceFrm" method="POST" enctype="multipart/form-data">
			...
			<input type="hidden" name="placeNo" id="placeNo" value="0" />
			<input type="hidden" name="nameValid" id="nameValid" value="0" />
			<!-- 전송버튼  -->
			<div class="list-group">
				<input type="submit" class="btn btn-outline-success" value="장소 등록" />
			</div>
		</form:form>
	</div>
</div>
		...
		$.ajax({
            ...
            beforeSend : function() {
	   	    ...
	   	    success : function(data) {
		   	    //ajax redirect
		   	    if(data) {
		   	    	window.location.href = "${pageContext.request.contextPath}/admin/adminPlaceList.do";
		   	    }
	   	     },
	   	     error: console.log,
	   	     complete: function() {
